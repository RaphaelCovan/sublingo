...
- Saves your settings (language choices, appearance preferences, subtitle position, and your last 20 word translations) locally in your browser.

## Data we collect

**We do not operate our own servers, and we do not collect, store, or have access to any of your data ourselves.**
...
- Your browsing history or the list of videos you watch over time
- Location data
- Authentication credentials
- Financial or payment information
- Keystrokes, mouse activity, or other behavioral tracking
...
- Subtitle position on the video
- Custom style presets you create
- Your last 20 word translations (for the History tab)

None of this local data is transmitted to us or to any third party. It stays on your device and can be cleared at any time by resetting the relevant setting in the extension, or by removing the extension entirely.
