...
// Standard ISO 639-1 languages, covering the set YouTube's caption
...
export const LANGUAGES: Language[] = [
  ...
  { code: 'ceb', name: 'Cebuano' }, { code: 'zh-Hans', name: 'Chinese (Simplified)' },
  { code: 'zh-Hant', name: 'Chinese (Traditional)' }, { code: 'co', name: 'Corsican' },
  ...
  { code: 'ny', name: 'Nyanja (Chichewa)' }, { code: 'or', name: 'Odia' },
  { code: 'ps', name: 'Pashto' }, { code: 'fa', name: 'Persian' },
  { code: 'pl', name: 'Polish' }, { code: 'pt', name: 'Portuguese' },
  { code: 'pt-BR', name: 'Portuguese (Brazil)' }, { code: 'pa', name: 'Punjabi' },
  ...
  { code: 'ug', name: 'Uyghur' }, { code: 'uz', name: 'Uzbek' },
